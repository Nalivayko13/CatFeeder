...
В  дальнейшем развитие приложения подразумевает расширенный спектр возможностей пользователя: добавление и управление неограниченным количеством кормушек, экспорт и импорт логов, составление индивидуального расписания для каждого из питомцев, мониторинг состояния кормушки, осуществление ручного управления, эмуляция поведения котов и кроссплатформенность. Реализация отдельных возможностей администратора: регистрация новых пользователей, добавление в систему новой кормушки, мониторинг состояний всех кормушек,управление системой логирования, в которой отображаются все действия всех пользователей и все изменения статусов кормушек. 

Ждите наше приложение в PlayMarket и AppStore!
